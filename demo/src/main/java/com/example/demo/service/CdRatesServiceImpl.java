...
public class CdRatesServiceImpl implements CdRatesService {
	...
	@Value("${cdrates.uri}")
	private String cdRatesUri;
 
	@Value("${cdhistoryrates.uri}")
	private String cdHistoryRatesUri;
	...
	public List<CdRatesDTO> getData(int zipCode) {
		...
		List<CdRates> cdRatesResponse = Arrays
				.asList(restTemplate.getForEntity(cdRatesUri + "/" + state, CdRates[].class).getBody());
	...
	public List<CdHistoryRatesDTO> getHistoryData(int zipCode) {
		...
		String state = getState(String.valueOf(zipCode));
		List<ArchiveCdRates> cdHisRatesResponse = Arrays
				.asList(restTemplate.getForEntity(cdHistoryRatesUri + "/" + state, ArchiveCdRates[].class).getBody());
